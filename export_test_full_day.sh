...
# VIDEO
# Usage: ./export_vid.sh
MASK_TYPE="results/t1/full_pysolar/test_100/images/input_label"
SPADE_OUT="results/t1/full_pysolar/test_100/images/synthesized_image"
REAL_OUT="datasets/testsets/val_one_day"
GAMMA_LABEL=1.0
GAMMA_IMAGE=2.2
/usr/bin/ffmpeg -y \
      ...
      -gamma $GAMMA_IMAGE -framerate 1 -f image2 -start_number 1 -thread_queue_size 1024  -i "$SPADE_OUT/20160521_%d.exr" \
     \
